        ...
        >
          <nav className="shrink-0 flex items-start justify-between px-[3.5rem] pt-[4rem]">
            ...
            >
              ...
              <span className="tracking-[-0.015rem]">Our Showreel</span>
            </button>
            <button
              type="button"
          ...
          <div className="relative flex-1 px-[3.5rem] pt-[9.5rem]">
            ...
            <div className="absolute left-[61%] top-[460%] leading-[1.48] tracking-[0.01em]">
              <p className="font-sans text-[30px] font-light text-white">
              ...
              <p className="mt-[20px] font-sans text-[18px] font-light leading-[1.55] text-white/45">
                {" "}
                Our goal is to deliver amazing experiences that make <br />{" "}
                people talk, and build strategic value for brands, tech, <br />{" "}
                entertainment, arts & culture.
              </p>
              <div className="mt-[60px] flex items-center gap-[11px] font-sans text-[12px] font-semibold text-white">
